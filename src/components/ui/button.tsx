...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", asChild = false, ...props }, ref) => {
    const variants = {
      ...
      premium: "bg-black text-white dark:bg-white dark:text-black hover:opacity-90 font-bold shadow-lg",
      gold: "gold-gradient text-white hover:opacity-90 font-bold shadow-lg border-none",
    };
